...
public class Burc {
	...
	public static void main(String[] args) {
		    ...
		    System.out.println("Hangi Gün Dođdunuz ? ");
		    gun = scanner.nextInt();

		    System.out.println("Hangi Ayda Dođdunuz ? (Örnek:1,2) ");
		    ay = scanner.nextInt();
		    ...
		    if ((gun >= 22 && gun <= 31 && ay== 1) || (gun >= 1 && gun <= 19 && ay == 2)) {
		        ...
		        System.out.println("Burcunuz: Ođlak");
		    }
